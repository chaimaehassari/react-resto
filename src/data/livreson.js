const livreson = {
  categories: [
    ...
    },
    {
      ...
      name: "Drinks",
      items: [
        { id: 401, name: "avocado", price: 2.50, description: "Jconst livreson = {
  categories: [
    {
      id: 1,
      name: "Appetizers",
      items: [
        ...
        },
        {
          ...
          price: 7.20,
          description: "Soupe traditionnelle française avec fromage fondu",
          image: "",
          category: "Entrées"
        }
      ]
      ...
      items: [
        {
          ...
          price: 12.50,
          description: "Pâtes italiennes avec sauce bolognaise",
        ...
        },
        {
          ...
          name: "Steak Frites",
          price: 15.90,
          description: "Steak de bœuf accompagné de frites maison",
          category: "Plats Principaux"
        }
      ]
    },
...
export default livreson;us d'avocado",  category: "Boissons" },
